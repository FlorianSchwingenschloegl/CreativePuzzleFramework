...
<head>
    ...
    <link rel="stylesheet" href="../lib/fontello/css/animation.css"><!--[if IE 7]>
    <link rel="stylesheet" href="../lib/fontello/css/fontello-ie7.css"><![endif]-->
        ...
        <div class="container">
            ...
            <div class="navbar-collapse collapse navpadding">
                <ul class="nav navbar-nav navbar-right">
                    ...
                    <li><a class="nav-link active">Komponenten</a></li>
                    ...
                    <li><a class="nav-link" href="../en/components/">en</a></li>
                </ul>
            </div>
        </div>
    </nav>
...
<aside class="aside">
    <ul class="section table-of-contents">
        ...
        <li class="aside-subnav"><a href="#size">Größe</a></li>
        <li class="aside-subnav"><a href="#buttonstil">Stil</a></li>
        <li class="aside-scroll"><a href="#cards">Karte</a></li>
        <li class="aside-subnav"><a href="#simplecard">Einfache Karte</a></li>
        <li class="aside-subnav"><a href="#cardfooter">Fußzeile</a></li>
        <li class="aside-subnav"><a href="#cardscontact">Kontakt Karte</a></li>
        <li class="aside-subnav"><a href="#cardmedia">Media Karte</a></li>
        <li class="aside-scroll"><a href="#header">Kopfzeile</a></li>
        <li class="aside-subnav"><a href="#brand">Brand Name</a></li>
        <li class="aside-subnav"><a href="#logo">Logo</a></li>
        <li class="aside-subnav"><a href="#headerstil">Stil</a></li>
        <li class="aside-subnav"><a href="#headerposition">Positionierung</a></li>
        <li class="aside-scroll"><a href="#navigation">Navigation</a></li>
        <li class="aside-subnav"><a href="#sidenav">Seiten Navigation</a></li>
        <li class="aside-subnav"><a href="#kopfzeile">Kopfzeile</a></li>
        <li class="aside-subnav"><a href="#content">Inhalt</a></li>
        <li class="aside-subnav"><a href="#sidenavfooter">Fußzeile</a></li>
        <li class="aside-subnav"><a href="#tabs">Tabs</a></li>
        <li class="aside-subnav"><a href="#dropdown">Dropdown</a></li>
        <li class="aside-subnav"><a href="#searchbar">Suchleiste</a></li>
        <li class="aside-scroll"><a href="#forms">Formulare</a></li>
        <li class="aside-subnav"><a href="#textfields">Textfelder</a></li>
        <li class="aside-subnav"><a href="#range">Regler</a></li>
        <li class="aside-subnav"><a href="#checkbox">Check Boxen</a></li>
        <li class="aside-subnav"><a href="#radiobutton">Radio Buttons</a></li>
        <li class="aside-scroll"><a href="#iconsection">Icons</a></li>
        <li class="aside-subnav"><a href="#include">Einbindung</a></li>
        <li class="aside-subnav"><a href="#collection">Kollektion</a></li>
        <li class="aside-scroll"><a href="#footer">Fußzeile</a></li>
        <li class="aside-subnav"><a href="#simplefooter">Einfache Fußzeile</a></li>
        <li class="aside-subnav"><a href="#links">Links</a></li>
        <li class="aside-subnav"><a href="#footerimpressum">Impressum</a></li>
        <li class="aside-subnav"><a href="#contact">Kontakt Informationen</a></li>
        <li class="aside-subnav"><a href="#footerposition">Positionierung</a></li>
    </ul>
</aside>
...
<main class="content">
    ...
    <article>
        ...
        <p>Sie wollen weitere Elemente auf Ihrer Webseite verwenden? Dann sind sie hier genau richtig! Falls Ihre
            ...
            Lebensituation veröffentlichen möchten, sollten Sie mit den Klassen im Bereicht Css auskommen.
            Doch nach sehr kurzer Zeit werden sich ihre Inhalte vervielfachen und eine einzige Seite kann so oft unübersichtlich wirken.
            Hier finden Sie Navigationsleisten um mehrere Seiten zu verbinden und vieles mehr!
        </p>
    </article>
        ...
        <div class="subnav-mobile">
            ...
            <nav>
                <ul class="dir_pad">
                    ...
                    <li>
                        <a class="margin-left directory" href="#size">Größe</a>
                    </li>
                    <li>
                        <a class="margin-left directory" href="#buttonstil">Stil</a>
                    </li>

                    <!---------------------------------------- Nav Cards ---------------------------------------->
                    <li>
                        <a class="directory" href="#cards">Karten</a>
                    </li>
                    <li>
                        <a class="margin-left directory" href="#simplecard">Einfache Karten</a>
                    </li>
                    <li>
                        <a class="margin-left directory" href="#cardfooter">Fußzeile</a>
                    </li>
                    <li>
                        <a class="margin-left directory" href="#cardscontact">Kontakt Karte</a>
                    </li>
                    <li>
                        <a class="margin-left directory" href="#cardmedia">Media Karte</a>
                    </li>

                    <!---------------------------------------- Nav Header ---------------------------------------->
                    <li>
                        <a class="directory" href="#header">Kopfzeile</a>
                    </li>
                    <li>
                    ...
                    <li>
                        <a class="margin-left directory" href="#headerstil">Stil</a>
                    </li>
                    <li>
                        <a class="margin-left directory" href="#headerposition">Positionierung</a>
                    </li>
                    ...
                    <li>
                        <a class="margin-left directory" href="#sidenav">Seiten Navigation</a>
                    </li>
                    <li>
                        <a class="margin-left directory" href="#kopfzeile">Kopfzeile</a>
                    </li>
                    <li>
                        <a class="margin-left directory" href="#content">Inhalt</a>
                    </li>
                    <li>
                        <a class="margin-left directory" href="#sidenavfooter">Fußzeile</a>
                    </li>
                    <li>
                    ...
                    <li>
                        <a class="margin-left directory" href="#kopfzeile">Suchleiste</a>
                    </li>

                    <!---------------------------------------- Nav Navigation ---------------------------------------->
                    <li>
                        <a class="directory" href="#forms">Formulare</a>
                    </li>
                    <li>
                        <a class="margin-left directory" href="#textfields">Textfelder</a>
                    </li>
                    <li>
                        <a class="margin-left directory" href="#range">Regler</a>
                    </li>
                    <li>
                        <a class="margin-left directory" href="#checkbox">Check Boxen</a>
                    </li>
                    <li>
                    ...
                    <!---------------------------------------- Nav Icons ---------------------------------------->
                    <li>
                        <a class="directory" href="#iconsection">Icons</a>
                    </li>
                    <li>
                        <a class="margin-left directory" href="#include">Einbindung</a>
                    </li>
                    <li>
                        <a class="margin-left directory" href="#collection">Kollektion</a>
                    </li>

                    <!---------------------------------------- Nav Footer ---------------------------------------->
                    <li>
                        <a class="directory" href="#footer">Fußzeile</a>
                    </li>
                    <li>
                        <a class="margin-left directory" href="#simplefooter">Einfache Fußzeile</a>
                    </li>
                    <li>
                        <a class="margin-left directory" href="#links">Links</a>
                    </li>
                    <li>
                        <a class="margin-left directory" href="#footerimpressum">Impressum</a>
                    </li>
                    <li>
                        <a class="margin-left directory" href="#contact">Kontakt Information</a>
                    </li>
                    <li>
                        <a class="margin-left directory" href="#footerposition">Positionierung</a>
                    </li>
                </ul>
            </nav>
        </div>
    ...
    <article id="buttons" class="section scrollspy">
        <h2>Buttons</h2>
        <p>Ein weiteres wichtiges Gestaltungselement sind Buttons. Das Framework bietet ein Standarddesign für Buttons das über den
            Klassennamen <i class="classname">.bttn</i> aufgerufen werden. Der Button ist standardgemäß mittelgroß und hat die Hintergrundfarbe
            Blau sowie leicht abgerundete Ecken. Die Buttonschrift hat eine Größe von 1rem und der Button hat überall einen kleinen Innnenabstand.
        </p>
...
<button class="bttn gray">Button</button></xmp></pre>
    ...
    <article id="size" class="section scrollspy">
        <h3>Gr&ouml;ße</h3>
        <p>Um die Schriftgröße sowie die Buttongröße anzupassen können zusätzlich die Klassen <i class="classname">.ex-sl,</i> <i class="classname">.sl,</i>
            <i class="classname">.md,</i> <i class="classname">.lg</i> und <i class="classname">.ex-lg</i> verwendet werden. Die Klasse
            <i class="classname">.ex-sl</i> beinhaltet die kleinstmögliche Größe und die Klasse <i class="classname">.ex-lg</i> die größtmögliche Größe.
        </p>
        <div class="row content_code center spacearound">
...
<button class="bttn ex-sl">Button</button></xmp></pre>
    ...
    <article id="buttonstil" class="section scrollspy">
        <h3>Stil</h3>
        <p>Weiteres gibt es Klassen die den Buttons zusätzliche Styles geben wie <i class="classname">.square,</i>  <i class="classname">.round</i>
            und <i class="classname">.ex-round.</i> Die Klasse <i class="classname">.square</i> macht den Button komplett eckig und die Klasse
            <i class="classname">ex-round</i> komplett rund. Durch <i class="classname">.round</i> werden die Ecken nur leicht abgerundet.
        </p>
        <div class="row content_code center spacearound">
...
<button class="bttn ex-round">Button</button></xmp></pre>
    ...
    <article id="cards" class="section scrollspy">
        <h2>Karten</h2>
        <p>Die Karte ist ein praktisches Element des Frameworks das es möglich macht verschiedene Inhalte auf eine Komponente zusammenzufassen.
            Es gibt verschiedene Typen von Karten die dem Benutzer eine Auswahl bieten seinen gewünschten Inhalt passend und einfach darzustellen.
            Weiteres eigenen sich Karten perfekt mehrere Elemente mit ähnlichen Inhalt als Sammlung darzustellen oder Zusatzinformationen anzuzeigen.
            Jede Karte besteht aus einer <i class="classname">.header,</i> <i class="classname">.content</i> und <i class="classname">.footer</i> Klasse.
            Im Header sollte sich die Überschrift befinden. Die <i class="classname">.content</i> Klasse beinhaltet den Inhalt der Karte und die
            <i class="classname">.footer</i> Klasse enthält zusätzliche Informationen oder Links.
        </p>
    </article>

    <article id="simplecard" class="section scrollspy">
        <h3>Einfache Karte</h3>
        <p>Die einfache Karte kann über den Klassenname <i class="classname">.simple-card</i> aufgerufen werden und besteht nur aus Text gegliedert
            in den Titel der Karte welcher sich im <i class="classname">.header</i> befinden sollte. In Textinhalt der Karte welcher sich in der
            <i class="classname">.content</i> Klasse und dem <i class="tagname">p</i> Tag befinden sollte und in zusätzliche Informationen 7
            oder Links welche sich in der <i class="classname">.footer</i> Klasse befinden sollten.
        </p>
...
<pre class="prettyprint"><xmp><div class="simple-card">
    ...
    <article id="cardfooter" class="section scrollspy">
        <h3>Fußzeile</h3>
        <p>
            Die Fußzeile der Karte besteht aus der <i class="classname">.footer</i> Klasse. Sie ist durch eine horizontale Linie vom Rest
            der Karte getrennt. Die Fußzeile einer Karte eignet sich perfekt um kurze Zusatzinformationen sowie Verlinkungen zu platzieren.
            Um Links ein spezielles Aussehen zu verleihen könne die Klassen für Links verwendet werden welche auf der Typografie Seite erklärt werden.
        </p>
        <div class="row center content_code">
            <div class="simple-card">
...
<pre class="prettyprint"><xmp><div class="simple-card">
    ...
    <article id="cardscontact" class="section scrollspy">
        <h3>Kontakt Karte</h3>
        <p>Das Framework bieten zusätzlich auch noch eine Kontaktkarte an welche dazu verwendet werden kann um Personenbeschreibungen oder
            ähnliche Informationen darzustellen. Sie besteht aus einem kleinen Bild in der rechten oberen Ecke einem Titel, Inhalt und einem Footer.
            Die Karte kann durch die Klasse <i class="classname">.contact-card</i> aufgerufen werden und ist ebenfalls in einen
            <i class="classname">.header,</i> <i class="classname">.content</i> und <i class="classname">.footer</i> unterteilt.
        </p>
        <div class="row center content_code">
...
<pre class="prettyprint"><xmp><div class="contact-card">
    ...
    <article id="cardmedia" class="section scrollspy">
        <h3>Media Karte</h3>
        <p>Die Besonderheit der Media Karte ist, dass sie in den <i class="classname">.header</i> ein Bild eingefügt werden kann. Sie besteht ebenfalls aus dem
            <i class="classname">.header,</i> <i class="classname">.content</i> und <i class="classname">.footer</i> und kan  über die Klasse
                <i class="classname">.media-card</i> aufgerufen werden.</i> Das Bild sollte durch den <i class="tagname">&lt;img&gt;</i>
            Tag in der <i class="classname">.header</i> Klasse eingefügt werden und der Titel der Karte sollte die Klasse <i class="classname">.title</i> übergeben werden.
        </p>
        <div class="row center content_code">
...
<pre class="prettyprint"><xmp><div class="media-card">
    ...
    <article id="header" class="section scrollspy">
        <h2>Kopfzeile</h2>
        <p>
            Da jede größere Website eine Navigation benötigt stellt das Framework verschiedene Klassen bereit um das zu realisieren.
            Die Kopfzeile besteht aus einem Container und verschiedenen Elementen die frei wählbar sind und im Container latziert werden können.
            Der Container kann über die Klasse <i class="classname">.nav-container</i> aufgerufen werden und sollte im <i class="tagname">nav</i> Tag platziert
            werden damit die Semantik nicht außer Acht gelassen wird.
        </p>
        <div class="row center content_code">
        ...
        <div class="codeBox">
            <code>
<pre class="prettyprint"><xmp><nav class="nav-container">
    ...
    <article id="brand" class="section scrollspy">
        <h3>Brand Name</h3>
        <p>Der Brand Name ist eine Klasse die nur innerhalb der <i class="classname">.nav-container</i> Klasse verwendet werden kann.
            Er kann über die Klasse <i class="classname">.brand-name</i> aufgerufen werden und ist dazu da den Markennamen bzw. Firmenname
...
<pre class="prettyprint"><xmp><a class="brand-name" href="#">CompanyName</a></xmp></pre>
    ...
    <article id="logo" class="section scrollspy">
        <h3>Logo</h3>
        <p>Um ein Logo in die Kopfzeile einzubinden kann die Klasse <i class="classname">.logo</i> übergeben werden sie kann ebenfalls nur in einem
            <i class="classname">.nav-container</i> verwendet werden und ist dazu dar, das Logo in der Navigation zu platzieren.
        </p>
        <div class="row center content_code">
            <nav class="nav-container">
                <img class="logo" src="../lib/img/creative_puzzle_v1.5.1_.png" alt="Creative Puzzle Logo">
...
<pre class="prettyprint"><xmp><img class="logo" src="../lib/img/creative_puzzle_v1.5.1_.png" alt="Creative Puzzle Logo"></xmp></pre>
    ...
    <article id="headerstil" class="section scrollspy">
        <h3>Stil</h3>
        <p>Die Klasse <i class="classname">.icon-container</i> ermöglicht es einfach Social Media Icons in die Kopfzeile einzufügen.
            Weiteres gibt es noch eine Option um Dropdown Menus zu realisieren. Die Klasse <i class="classname">.drop-menu</i> sollte nur an ein
            <i class="classname">.nav-item</i> übergeben werden. Damit das Dropdown Menu auch ausklappt muss dem jeweiligen <i class="classname">.nav-item</i>
            auch die Klasse <i class="classname">.drop-toggle</i> übergeben werden. Alle Elemente die innerhalb eines <i class="classname">.drop-menu</i> liegen benötigen
            die Klasse <i class="classname">.drop-item</i> um auch richtig dargestellt zu werden.
        </p>
        <div class="row center nav-dropdown_demo">
            <nav class="nav-container nav-center" id="nav-collapse">
                <img class="logo" src="../lib/img/creative_puzzle_v1.5.1_.png" alt="Creative Puzzle Logo">
                <a class="brand-name" href="#">CompanyName</a>
                <div class="nav">
                    <ul>
                        ...
                        <a href="javascript:void(0);" class="collapse" onclick="collapse()"></a>
                    </ul>
                </div>
                <div class="icon-container">
                    <img src="../lib/img/twitter.png" alt="twitter icon">
        ...
        <div class="codeBox">
            <code>
<pre class="prettyprint"><xmp><nav class="nav-container nav-center" id="nav-collapse">
    <img class="logo" src="../lib/img/creative_puzzle_v1.5.1_.png" alt="Creative Puzzle Logo">
    <a class="brand-name" href="#">CompanyName</a>
    <div class="nav">
        <ul>
    ...
    <article id="headerposition" class="section scrollspy">
        ...
        <p>
            m die Kopfleiste nach belieben zu positionieren stellt das Framework einige Klassen bereit die im <i class="classname">.nav-container</i>
            verwendet werden können. Die Klasse <i class="classname">.nav-strech</i> kann dazu verwendet werden um die Elemente so zu strecken,
            das der ganze Container ausgefüllt wird. Die Klasse <i class="classname">.nav-center</i> richtet alle Elemente innerhalb des
            <i class="classname">.nav-container</i> zentriert aus. Ebenso positionieren die Klassen <i class="classname">.nav-start</i> und
            <i class="classname">.nav-end</i> alle Elemente an den  Anfang oder an das Ende eines Containers. Die Klassen <i class="classname">.nav-around</i>
            und <i class="classname">.nav-evenly</i> sind für die Abstände zwischen den einzelnen Elementen zuständig. Durch <i class="classname">.nav-around</i>
            wird der Abstand um jedes Element gleich aufgeteilt. Die Klasse <i class="classname">.nav-evenly</i> teilt den Abstand zwischen den Elementen gerecht auf.
        </p>
        <h4>Nav Center</h4>
        <div class="row center content_code">
            <nav class="nav-container nav-center" id="nav-collapse">
        ...
        <h4>Nav Start</h4>
        <div class="row center content_code">
            <nav class="nav-container nav-start" id="nav-collapse">
                <img class="logo" src="../lib/img/creative_puzzle_v1.5.1_.png" alt="Creative Puzzle Logo">
                <a class="brand-name" href="#">CompanyName</a>
                <div class="nav">
                    <ul>
        ...
        <h4>Nav End</h4>
        <div class="row center content_code">
            <nav class="nav-container nav-end" id="nav-collapse">
                <img class="logo" src="../lib/img/creative_puzzle_v1.5.1_.png" alt="Creative Puzzle Logo">
                <a class="brand-name" href="#">CompanyName</a>
                <div class="nav">
                    <ul>
        ...
        <div class="codeBox">
            <code>
                <pre class="prettyprint"><xmp><nav class="nav-container nav-center"></nav>

<nav class="nav-container nav-start"></nav>

<nav class="nav-container nav-end"></nav></xmp></pre>
            </code>
        </div>
    </article>
    ...
    <article id="navigation" class="section scrollspy">
        <h2>Navigation</h2>
        <p>Die Hauptnavigation ist neben dem Content das wichtigste Element einer Website. Sie sollte klar strukturiert
            und leicht zugänglich sein. Die einzelnen Menüpunkte sollten klar und deutlich erkennbar sein und nur aus den
            wichtigsten Bereichen der Website bestehen. Der Besucher der Seite darf nicht verwirrt werden. Ziel einer guten
            Navigation ist es, mit möglichst wenig Verweisen möglichst viele Seiten zu erreichen.
        </p>
    </article>

    <article id="sidenav" class="section scrollspy">
        <h3>Seiten Navigation</h3>
        <p>Die Seiten Navigation kann mit der Klasse <i class="classname">.side-nav-container</i> aufgerufen werden. Sie besteht aus einem Container und ist in
            <i class="classname">.side-nav-header,</i> <i class="classname">.side-nav-content</i> und <i class="classname">.side-nav-footer</i> unterteilt.
        </p>
        <div class="row center content_code">
...
<pre class="prettyprint"><xmp><nav class="side-nav-container">
    ...
    <article id="kopfzeile" class="section scrollspy">
        <h3>Kopfzeile</h3>
        <p>
            In den <i class="classname">.side-nav-header</i> kann ein Logo über mit dem <i class="tagname">&lt;img&gt;</i> Tag platziert werden sowie
            eine Suchleiste die über die Klasse <i class="classname">.searchbar</i> gestylt werden kann
        </p>
        <div class="row center content_code">
...
<pre class="prettyprint"><xmp><nav class="side-nav-container side-nav-container_header_demo">
    ...
    <article id="content" class="section scrollspy">
        <h3>Inhalt</h3>
        <p>
            In den <i class="classname">.side-nav-content</i> können alle gewünschten Verweise über <i class="tagname">&lt;a&gt;</i> Tags eingefügt werden
            sie sind der wichtigste Bestandteil der Seiten Navigation.
        </p>
        <div class="row center content_code">
...
<pre class="prettyprint"><xmp><nav class="side-nav-container side-nav-container_content_demo">
    ...
    <article id="sidenavfooter" class="section scrollspy">
        <h3>Fußzeile</h3>
        <p>
            In den <i class="classname">.side-nav-footer</i> können Links sowie das Impressum platziert werden.
            Er ist zentriert und wird ist durch eine Linie vom Inhalt der Seitennavigation getrennt.
        </p>
        <div class="row center content_code">
...
<pre class="prettyprint"><xmp><nav class="side-nav-container side-nav-container_footer_demo">
    ...
    <article id="tabs" class="section scrollspy">
        <h3>Tabs</h3>
        <p>
            Tabs sind eine gute Alternative zu Navigationsleisten. In ihrer Funktion sind Sie ident. Je nach Anzahl werden Listeneinträge
            hinzugefügt, diese können mit anderen Seiten verknüpft werden. Die Klasse <i class="classname">.active</i> wird jeweils auf der aktiven Seite eingefügt
            und verdeutlicht den Aufenthaltsort des Users.
        </p>
        <div class="row center content_code">
...
<pre class="prettyprint"><xmp><header class="tab-nav">
    ...
    <article id="dropdown" class="section scrollspy">
        <h3>Dropdown</h3>
        <p>
            Ebenso wie Tabs bieten sich auch Dropdowns als  Navigation einer Seite an. Jedes Dropdown Element besteht aus
            mehrern Listen Elementen welche beim Überfahren mit der Maus ausgeklappt werden. Jedes Dropdown Element kann beliebig
            viele Listen Elemente beinhalten.
        </p>
...
<pre class="prettyprint"><xmp><div class="dropdown-main">
    ...
    <article id="searchbar" class="section scrollspy">
        <h3>Suchleiste</h3>
        <p>
            Zusätzlich beinhaltet das Framework eine Klasse <i class="classname">.search-bar</i> oder <i class="classname">.side-nav-search</i> die
            in einem <i class="tagname">&lt;input&gt;</i> Tag verwendet werden sollte um das Standarddesign einer Suchleiste aufzurufen.
        </p>
        <div class="row center content_code">
...
<pre class="prettyprint"><xmp><input type="search" class="searchbar" placeholder="search . . ."></xmp></pre>
    ...
    <article id="forms" class="section scrollspy">
        <h2>Formulare</h2>
        <p>
            Formulare bieten dem Benutzer eine Möglichkeit Eingabedaten zu erfassen. Da Formularelemente default in jeden Browser ein unterschiedliches
            Aussehen haben, bietet unser Framework auch einige Klasse um diese Elemente zu stylen.
        </p>
    </article>
    ...
    <article id="textfields" class="section scrollspy">
        <h3>Textfelder</h3>
        <p>
            Das Textfeld ist eines der wichtigsten Formularelemente und kann über den Klassennamen <i class="classname">.textfield</i> aufgerufen werden.
            Zusätzlich gibt es die Klasse <i class="classname">.flatfield</i> welche das Textfeld nur mit einem Unterstrich darstellt.
        </p>
...
<input type="text" class="flatfield" placeholder="Flatfield"></xmp></pre>
    ...
    <article id="range" class="section scrollspy">
        <h3>Regler</h3>
        <p>
            Der Regler hat defaultmäßig in jedem Browser ein anderes Design. Dafür beinhaltet unser Framework die Klasse <i class="classname">.slider</i>
            die dem Regler ein Standarddesign übergibt das in jedem Browser gleich aussieht. Zusätzlich gibt es noch die Klassen <i class="classname">.slider-flat</i>
            und <i class="classname">.slider-material</i> die dem Regler ein anderes Aussehen geben.
        </p>
        <div class="row content_code center">
...
<input type="range" class="slider-material" /></xmp></pre>
    ...
    <article id="checkbox" class="section scrollspy">
        <h3>Checkbox</h3>
        <p>
            Da Checkboxen defaultmäßig kein anschauliches Design aufweisen bietet das Framework ebenfalls ein Standarddesign das über die Klassen
            <i class="classname">.checkbox</i> und <i class="classname">.checkbox-cancle</i> aufgerufen werden kann. Die <i class="classname">.checkbox</i>
            Klasse wird bei aktivieren durch ein grünes Hackerl makiert. Die <i class="classname">.checkbox-cnacle</i> Klasse wird bei aktivieren durch
            ein rotes Kreuz makiert. Zusätzlich kann bei den Klassen die Option <i class="classname">-dark</i> und <i class="classname">-light</i>
            ausgewählt werden und sollte der gewünschten <i class="classname">.checkbox</i> Klasse zugeordnet werden.
        </p>
        <div class="row content_code center">
...
<input type="checkbox" class="checkbox-cancle-light"></xmp></pre>
    ...
    <article id="radiobutton" class="section scrollspy">
        <h3>Radio Buttons</h3>
        <p>
            Radio Button Styles können über den Klassenname .<i class="classname">radio-bttn-light</i> und <i class="classname">.radio-bttn-dark</i>
            aufgerufen werden.
        </p>
        <div class="row content_code center">
            <div class="col xs12 s12 md6 l6 xl6">
...
<input type="radio" class="radio-bttn-dark" /></xmp></pre>
    ...
    <article id="iconsection" class="section scrollspy">
        <h2>Icons</h2>
        <p>
            Um Aktionen oder Einträge zu vereinfachen und zu symbolisieren wurden simplifizierte Icons verwendet. Sie beinhalten weder
            aufwändige Grafiken noch Farbschemen. Es wurde simple Vektoren verwendet um sowohl die Responsiveness als auch das Verständnis
            zu bewahren. Um eine Vielzahl an Icons bereitzustellen wurde die Bibliothek <a class="icon_link_demo" href="http://fontello.com">Fontello</a> verwendet.
            Darunter sind verschiedene Icon Fonts (FontAwesome, Entypo, Typicons, Iconic, Modern Pictograms, Meteocons, MFG Labs, Maki, Zocial,
            Brandico, Elusive, Linecons und Web Symbols) vertreten, die der <a class="icon_link_demo" href="https://de.wikipedia.org/wiki/SIL_Open_Font_License">SIL</a>,
            <a class="icon_link_demo" href="https://de.wikipedia.org/wiki/BSD-Lizenz">BSD</a>, <a class="icon_link_demo" href="https://de.wikipedia.org/wiki/MIT-Lizenz">MIT</a>
            oder <a class="icon_link_demo" href="https://de.wikipedia.org/wiki/Creative_Commons">CC</a> Lizenzen unterliegen und somit in eigene Projekte eingebunden werden dürfen,
            allerdings ist eine namentliche Nennung im Quellcode zwingend anzuführen. Weitere Informationen entnehmen Sie bitte den angeführten Links.
        </p>
    </article>
    ...
    <article id="include" class="section scrollspy">
        <h3>Include</h3>
        <p>
            Die jeweiligen Klassen, bzg. Schriftcodes werden unter Kollektionen aufgeführt. Die Icons können über den <i class="tagname">&lt;span&gt;</i>
            Tag mit dem jeweiligen Icon Klassennamen aufgerufen werden. Zusätzlich muss der dazu gehörige Code im <i class="tagname">&lt;span&gt;</i>
            Tag durch ein <i class="varname">#&</i> und die gewünschte Nummer  angegeben werden.
        </p>
        <div class="codeBox">
            <code>
...
<span class="icon-music">&#xe801;</span>Icons Music</xmp></pre>
    ...
    <article id="footer" class="section scrollspy">
        <h2>Fußzeile</h2>
        <p>
            Die Fußzeile ist ein wichtiger Bestandteil einer Website, da sie meist entweder Kontaktinformationen oder Informationen über das Unternehmen
            beinhaltet. Die Fußzeile besteht aus einem Container einem Inhalt und einer zusätzlichen Fußzeile. Der Container lässt sich über den
            Klassennamen <i class="classname">.footer-container</i> aufrufen. Im Fußzeilen Container kann sich der Benutzer frei aussuchen welche
            Elemente er in die Fußzeile einfügen will. Mit der Klasse <i class="classname">.footer-content</i> kann Text einfach gestylt werden.
            Für Überschriften gibt es die Klasse <i class="classname">.footer-title.</i> Alle <i class="tagname">&lt;p&gt;</i> Tags innerhalb der
            <i class="classname">.footer-content</i> Klasse weisen ein bestimmtes Design auf. Weiters gibt es eine Klasse <i class="classname">.icon-container</i>
            in der gewünschte Social Media Icons platziert werden können. Jedes Icon sollte die Klasse <i class="classname">.footer-icon</i>
            zugewiesen werden um das Gesamtdesign zu gewährleisten. Durch die Klasse <i class="classname">.footer-logo</i> lassen sich ebenfalls Logos
            im Footer platzieren.
        </p>
        <div class="row center content_code">
...
<pre class="prettyprint"><xmp><footer class="footer-container">
    ...
    <article id="simplefooter" class="section scrollspy">
        <h3>Einfache Fußzeile</h3>
        <p>
            Zusätzlich zu den anderen Elementen bietet das Framework eine Fußzeile in der Fußzeile in die Zusatzinformationen wie Verweise auf
            andere Seiten oder das Impressum platziert werden können. Die Fußzeile lässt sicher über die Klasse <i class="classname">.footer-line</i>
            aufrufen.
        </p>
        <div class="row center content_code">
            <footer class="footer-container">
...
<pre class="prettyprint"><xmp><footer class="footer-container">
    ...
    <article id="links" class="section scrollspy">
        <h3>Links</h3>
        <p>
            Durch die Klasse <i class="classname">.footer-link</i> lässt sich ein spezielles Design für Links in der Fußzeile aufrufen.
            Es können ebenfalls die Klassen der anderen Links aufrufen welche unter dem Menüpunkt  Typografie und der Überschrift Links beschrieben werden.
        </p>
        <div class="row center content_code">
            <div class="footer-line center">
                <a class="footer-link" href="#">Impressum</a>
...
<pre class="prettyprint"><xmp><div class="footer-line center">
    ...
    <article id="footerimpressum" class="section scrollspy">
        <h3>Impressum</h3>
        <p>
            Das Impressum ist eine gesetzlich vorgeschriebene Herkunftsangabe bei Publikationen. Es sollte von jeder Seite zugänglich sein deswegen
            bietet es sich hervorragend an das Impressum  in der Fußzeile einer Seite zu platzieren.
        </p>
        <div class="row center content_code">
            <footer class="footer-container">
                <p class="footer-title">
...
<pre class="prettyprint"><xmp><footer class="footer-container">
    ...
    <article id="contact" class="section scrollspy">
        ...
        <p>Auch für Kontakt Informationen ist die Fußzeile eine gute Möglichkeit sie darzustellen. Es können beispielsweise Links die den Besucher
            auf andere Seiten verweisen platziert werden. Durch die Klasse <i class="classname">.footer-logo</i> lassen sich ebenfalls eigene
            Logos sowie die von Sponsoren einfach einbinden.
        </p>
        <div class="row center content_code">
            <footer class="footer-container">
                <p class="footer-title">
...
<pre class="prettyprint"><xmp><footer class="footer-container">
    ...
    <article id="footerposition" class="section scrollspy">
        <h3>Positionierung</h3>
        <p>
            Die Positionierung des Footer ist normal in einer Spalte realisiert. Alle hinzugefügten Elemente werden unterhalb des vorigen Elements angeordnet.
            Um der Fußzeile zusätzliche Positionierungsoptionen zu geben stellt das Framework zwei Klassen bereit. Die Klasse <i class="classname">.footer-center</i>
            zentriert den vorhanden Inhalt der Fußzeile. Mit der Klasse <i class="classname">.footer-row</i> ändern die Inhaltselemente des Footers ihre Positionierung
            in eine Reihe anstatt einer Spalte.
        </p>
