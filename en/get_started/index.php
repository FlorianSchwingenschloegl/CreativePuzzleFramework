...
<aside class="aside">
    <ul class="section table-of-contents">
        ...
        <li class="aside-scroll"><a href="#includesass">Compiling Sass</a></li>
    </ul>
</aside>
    ...
    <div class="row">
        <div class="subnav-mobile">
            ...
            <nav>
                <ul class="dir_pad">
                    <li>
                        <a class="directory" href="#download">Download</a>
                    </li>
                    <li>
                        <a class="directory" href="#cdn">CDN</a>
                    </li>
                    <li>
                        <a class="directory" href="#sourcecode">Source Code</a>
                    </li>
                    <li>
                        <a class="directory" href="#includecss">Include CSS</a>
                    </li>
                    <li>
                        <a class="directory" href="#includesass">Compiling Sass</a>
                    </li>
                </ul>
            </nav>
        </div>
...
└── scss/</xmp></pre>
    ...
    <article id="includecss" class="section scrollspy">
        ...
        <p>
            ...
            Mit ' / ' können sie tiefer in Verzeichnisse wechseln und mit ' ../ ' aus einem Verzeichnis
            hinaus wechseln.
        </p>
        <div class="codeBox">
            <code>
